package com.android.fury.Dambel.alarm.sham;
...
public class NotificationIntentService extends IntentService {
    ...
    private void processStartNotification() {
        ...
        once = one_play_preferences.getInt("one_play_notification_5", 0);
        ...
        if (date == 21){
            if (once == 0) {
                ...
                String t1 = "شام می دونی باید چی بخوری؟";
                String t2 = "شام یادت نره چی بخوری!";
                String t3 = "رژیم رعایت کن!";
                String t4 = "روز چند رژیمی ؟";
                String t5 = "شام چی داری؟";
                String t6 = "شام یادت نره! منظورم رژیم";
                String t7 = "عجب شامی داری امشب!";
                String t8 = "برنامه غذایی رعایت می کنی؟";
                String t9 = "می دونی شامت چی؟";
                String t10 = "شام یادت نره چی بخوری!";
            ...
            NotificationEventReceiver4.getDeleteIntent(this);
            once = 0;
            one_play_editor.putInt("one_play_notification_5", once);
            one_play_editor.apply();
        }
