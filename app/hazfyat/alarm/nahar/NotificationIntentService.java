package com.android.fury.Dambel.alarm.nahar;
...
public class NotificationIntentService extends IntentService {
    ...
    private void processStartNotification() {
        ...
        once = one_play_preferences.getInt("one_play_notification_4", 0);
        ...
        if (date == 13){
            if (once == 0) {
                ...
                String t1 = "ناهار میدونی باید چی بخوری ؟";
                String t2 = "ناهار یادت نره چی بخوری!";
                String t3 = "رژیم رعایت کن!";
                String t4 = "روز چند رژیمی ؟";
                String t5 = "ناهار چی داری؟";
                String t6 = "ناهار یادت نره! منظورم رژیم";
                String t7 = "عجب ناهاری داری امروز!";
                String t8 = "برنامه غذایی رعایت می کنی؟";
                String t9 = "می دونی ناهارت چی؟";
                String t10 = "ناهار یادت نره چی بخوری!";
            ...
            NotificationEventReceiver3.getDeleteIntent(this);
            once = 0;
            one_play_editor.putInt("one_play_notification_4", once);
            one_play_editor.apply();
        }
