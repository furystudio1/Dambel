...
public abstract class BaseCurveProgressView extends View {
     ...
     * Line color
     */
    protected int mColor = getResources().getColor(R.color.text_color_2);
    ...
    public BaseCurveProgressView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setColor(a.getColor(R.styleable.BaseCurveProgressView_lineColor, ContextCompat.getColor(context, R.color.text_color_2)));
    ...
    protected static class BaseCurveSavedState extends BaseSavedState {
        ...
        public static final Creator<BaseCurveSavedState> CREATOR =
                new Creator<BaseCurveSavedState>() {
