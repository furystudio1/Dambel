 ...
 */
public class MyDatabaseHelper_flag extends SQLiteOpenHelper {
    public static final String DB_NAME = "flag_data_1.db";
    public static final String TBL_NAME = "flag_s_info";

    public MyDatabaseHelper_flag(Context context) {
