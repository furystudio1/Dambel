 ...
 */
public class MyDatabaseHelper_lan extends SQLiteOpenHelper {
    public static final String DB_NAME = "language.db";
    public static final String TBL_NAME = "language_info";

    public MyDatabaseHelper_lan(Context context) {
