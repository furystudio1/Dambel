package com.android.fury.Dambel.loadtoast;
...
public class LoadToastView extends ImageView {
    ...
    public LoadToastView(Context context) {
        ...
        successPaint.setColor(ContextCompat.getColor(context, R.color.color_success));
        errorPaint.setColor(ContextCompat.getColor(context, R.color.color_error));
