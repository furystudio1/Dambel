 ...
 */
public class MyDatabaseHelper_food_2 extends SQLiteOpenHelper {
    public static final String DB_NAME = "food_data_2.db";
    public static final String TBL_NAME = "food_s_info";

    public MyDatabaseHelper_food_2(Context context) {
