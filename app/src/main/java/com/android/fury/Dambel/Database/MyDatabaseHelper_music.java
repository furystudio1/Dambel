 ...
 */
public class MyDatabaseHelper_music extends SQLiteOpenHelper {
    public static final String DB_NAME = "music_data_sport_1.db";
    public static final String TBL_NAME = "music_sport_s_info";

    public MyDatabaseHelper_music(Context context) {
