 ...
 */
public class MyDatabaseHelper_vibre extends SQLiteOpenHelper {
    public static final String DB_NAME = "vebre_data_1.db";
    public static final String TBL_NAME = "vebre_s_info";

    public MyDatabaseHelper_vibre(Context context) {
