 ...
 */
public class MyDatabaseHelper_sound extends SQLiteOpenHelper {
    public static final String DB_NAME = "music_data_1.db";
    public static final String TBL_NAME = "music_s_info";

    public MyDatabaseHelper_sound(Context context) {
