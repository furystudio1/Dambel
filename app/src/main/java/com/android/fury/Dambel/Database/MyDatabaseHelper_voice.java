 ...
 */
public class MyDatabaseHelper_voice extends SQLiteOpenHelper {
    public static final String DB_NAME = "voice_data_1.db";
    public static final String TBL_NAME = "voice_s_info";

    public MyDatabaseHelper_voice(Context context) {
